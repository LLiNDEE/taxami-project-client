...
const TakeTaskForm = ({ takeTaskDetails, setTakeTaskDetails }) => {
    ...
    return (
        <div className="takeTaskForm">
            <Input label="Förväntad kostnad" value={takeTaskDetails.estimated_cost} onChange={(e) => setTakeTaskDetails(v => ({...v, estimated_cost: e.target.value}))} />
            <Input label="Förväntad tid" value={takeTaskDetails.estimated_time} onChange={(e) => setTakeTaskDetails(v => ({...v, estimated_time: e.target.value}))} />
